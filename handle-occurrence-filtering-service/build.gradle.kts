...
application {
    mainModule.set("ks.connected.services.demo.handle.occurrence.filtering.service")
    mainClass.set("io.github.creek.service.ks.connected.services.demo.handle.occurrence.filtering.service.ServiceMain")
}
